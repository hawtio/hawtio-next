  ...
  <PageSection variant={PageSectionVariants.light}>
    <TextContent>
      ...
      <Text component='p'>
        ...
        JavaScript statement, the resulting bundle is much less optimized, because all Patternfly components
        used by <code>Example1</code> are loaded in <em>static way</em>. This approach can lead to increased size
        of chunks loaded when application starts, thus delaying initial UI response.
      </Text>
      <Text component='p'>
        Here's the simplest Hawtio plugin registration code:
      </Text>
      <CodeBlock>
        <CodeBlockCode>
